# 2026-06-19-지수통합선별공장-프로젝트관리표-통합노트-full-page-audit-fixed-legend-top

This folder is a static MarkTL HTML export bundle.

- Source note: 20_실행/프로젝트/2026년/지수 통합선별공장/00_타임라인/2026-06-19_지수통합선별공장_프로젝트관리표_통합노트_FULL_PAGE_AUDIT_FIXED_LEGEND_TOP.md
